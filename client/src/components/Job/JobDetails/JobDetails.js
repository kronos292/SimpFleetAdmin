...
import JobDetailsCard from './JobDetailCard'
                                        ...
                                        <Col xs={12} md={{span: 10, offset: 1}}>
                                            <Paper elevation={0} className='job-detail-breadcrumbs' square={true}>
                                                <Breadcrumbs separator={<NavigateNextIcon fontSize="small"/>}
                                                    ...
                                                    <h4>{/* {this.state.job.vessel.vesselName.toUpperCase()}, {this.state.job.vessel.vesselIMOID} */}Vessel Name, vesselIMOID</h4>
                                                </Breadcrumbs>
                                            </Paper>
                                            <Paper square={true}>
                                                <Paper className='job-details-ship-title' square={true}>
                                                    <div className='d-flex align-items-center'>
                                                        <h1 className='job-detail-fonts'
                                                            style={{marginBottom: '0px'}}>{/* {this.state.job.vessel.vesselName.toUpperCase()} {this.state.job.vessel.vesselIMOID} */}Vessel Name, vesselIMOID</h1>
                                    ...
                                    <Row>
                                        <Paper elevation={0} square={true}
                                            ...
                                            <Breadcrumbs separator={<NavigateNextIcon fontSize="small"/>}
                                                ...
                                                <h4 className='job-details-ship-title-font'>{/* {this.state.job.vessel.vesselName.toUpperCase()}, {this.state.job.vessel.vesselIMOID} */}Vessel Name, vesselIMOID</h4>
                                            </Breadcrumbs>
