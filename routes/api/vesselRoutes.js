...
router.get('/search', async (req, res) => {
    ...
    try {
        const res = await axios.get(`https://services.marinetraffic.com/api/shipsearch/${keys.MARINE_TRAFFIC_API_KEY_SEARCH}/shipname:${query}/protocol:jsono`);
        const result = res.data;
        for (let i = 0; i < result.length; i++) {
            let o = result[i];
            console.log(o)
            if (o.SHIPNAME !== '' && o.IMO !== '' && o.IMO !== '0' && o.CALLSIGN !== '' && o.SHIPNAME.toLowerCase() === query.toLowerCase()) {
                ...
                const vessel = await Vessel.findOne({vesselIMOID:o.IMO}).populate({
                ...
                if(vessel !== null) {
                    ...
                    if(marineTrafficVesselObj === null || marineTrafficVesselObj === undefined) {
